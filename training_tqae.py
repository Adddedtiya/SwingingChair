...
from models.model_veat           import TransAutoencoderV512
...
if __name__ == "__main__":
    ...
    # setup args
    parser = argparse.ArgumentParser(description = "TQ-AE Training configuration")
    ...
    autoencoder_model = TransAutoencoderV512(
