...
from helpers.wrapper_hegan       import WrapperHEGAN
from models.model_siaq           import LigweightAutoencoderK512
from models.model_mbdist         import MoGrayDist
...
if __name__ == "__main__":
    ...
    autoencoder_model.freeze_layers_except([
        'decoder.convolutional_layers.15',
        'decoder.convolutional_layers.16',
        'decoder.head'
    ])

    discriminator = MoGrayDist()
    model_wrapper = WrapperHEGAN(
